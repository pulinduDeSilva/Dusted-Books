        ...
        <div className="mb-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="mb-3 flex items-center gap-2.5">
              <img src={logoImage} alt="DustedBooks" className="h-9 w-9 object-contain" />
              <span className="bg-gradient-to-r from-amber-900 to-amber-700 bg-clip-text text-lg font-bold text-transparent dark:from-amber-400 dark:to-amber-300">
                DustedBooks
              </span>
            </div>
            <p className="text-sm leading-relaxed text-amber-900/50 dark:text-amber-200/40">
              Sri Lanka&apos;s marketplace for pre-loved books. Buy, sell, and request titles — and give every story a second life.
            </p>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-amber-900/50 dark:text-amber-200/40">
              Every book we sell is condition-checked and fairly priced. Selling? We arrange pickup from your location.
            </p>
          </div>
        </div>
