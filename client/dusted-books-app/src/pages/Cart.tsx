  ...
  return (
    <div className="min-h-screen bg-[#fcfaf8] dark:bg-gray-950 text-amber-950 dark:text-amber-100 font-sans selection:bg-amber-900 selection:text-white pt-28 pb-20">
      <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <section className="rounded-2xl bg-white dark:bg-gray-900 border border-amber-900/10 dark:border-gray-700 py-8 px-6 shadow-sm shadow-amber-900/5 dark:shadow-black/20">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                to="/browse"
                className="inline-flex items-center justify-center rounded-full border border-amber-700 bg-transparent px-3 py-2 text-xs font-semibold text-amber-700 transition hover:bg-amber-50 dark:border-amber-400 dark:text-amber-200 dark:hover:bg-gray-800"
              >
                Continue browsing
              </Link>
              {cartItems.length > 0 && (
                <button
                  type="button"
                  onClick={clearCart}
                  className="inline-flex items-center justify-center rounded-full bg-amber-900 px-5 py-2 text-sm font-semibold text-white transition hover:bg-amber-700"
                >
                  Clear cart
                </button>
              )}
          ...
          {cartItems.length === 0 ? (
            <div className="mt-12 rounded-2xl border border-dashed border-amber-200 dark:border-gray-700 bg-white dark:bg-gray-900/50 p-12 text-center">
              <h2 className="text-lg font-semibold text-amber-950 dark:text-amber-100">Your cart is empty.</h2>
              <p className="mt-3 text-amber-700/70 text-sm dark:text-amber-300/70">Add books from browse to see them here.</p>
            </div>
          ) : (
